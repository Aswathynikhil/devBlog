...
import posterNew from '../../img/posterNew.jpg'
const Homepage = () => {
  return (
    <>
      <section className="pb-10 bg-white-800">
        <div className="relative container px-4   mx-auto">
          <div className="flex flex-wrap items-center -mx-4 mb-10 2xl:mb-14">
            <div className="w-full lg:w-1/2 px-4 mb-16 lg:mb-0">
              ...
              <p className="mb-12 lg:mb-16 2xl:mb-24 text-xl text-black-100">
            ...
            <div className="w-full lg:w-1/2 px-5 mt-20">
              <img className="w-full" src={posterNew} alt={posterNew} />
            </div>
          </div>
        </div>
      </section>
