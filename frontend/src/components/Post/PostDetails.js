...
import { deletePostAction, fetchSinglePostDetailsAction } from "../../redux/slices/posts/postSlices";
...
const PostDetails = () => {
  ...
  return (
    ...
    {loading ? 
      ...
      <h1 className="h-screen text-red-400 text-xl">{appErr} {serverErr}</h1>:
      (
         <section class="py-20 2xl:py-40 bg-white-800 overflow-hidden">
     <div className="container px-4 mx-auto">
       {/* Post Image */}
       <img
         className="mx-auto w-300 h-96 "
         src={postDetails?.image}
         alt=""
       />
       <div className="max-w-2xl mx-auto text-center">
         <h2 className="mt-7 mb-14 text-4xl 2xl:text-4xl text-black font-bold font-heading">
         {postDetails?.title} 
         </h2>
